...
SAMSUNG: List[Row] = [
    ...
    ("Galaxy A05", "SM-A055F|a05m", "13 - 15", "MediaTek Helio G85", "2023-10", "USB-C"),
    ("Galaxy A15", "SM-A155F|a15", "14 - 15", "MediaTek Helio G99", "2023-12", "USB-C"),
    ("Galaxy A25", "SM-A256E|a25x", "14 - 15", "Exynos 1280", "2023-12", "USB-C"),
...
XIAOMI: List[Row] = [
    ...
    ("Redmi A2", "23028RNCAG|cloud", "12 - 13", "Unisoc T606", "2023-03", "USB-C"),
    ("Redmi 13C", "23106RN0DA|gale", "13 - 15", "MediaTek Helio G85", "2023-11", "USB-C"),
...
OPPO_VIVO_REALME: List[Row] = [
    ...
    ("Oppo A18", "CPH2591", "13 - 14", "MediaTek Helio G85", "2023-09", "USB-C"),
    ...
    ("Vivo Y02", "V2217|Y02", "12 - 13", "MediaTek Helio P35", "2022-04", "Micro-USB"),
    ("Vivo Y16", "V2204", "12 - 13", "MediaTek Helio P35", "2022-05", "Micro-USB"),
    ("Vivo Y22", "V2207", "12 - 13", "MediaTek Helio G70", "2022-09", "USB-C"),
    ("Vivo Y27", "V2248", "13 - 14", "MediaTek Helio G85", "2023-07", "USB-C"),
    ...
    ("Realme C53", "RMX3760", "13 - 14", "Unisoc T612", "2023-05", "USB-C"),
...
OTHER_ANDROID: List[Row] = [
    ...
    ("Tecno Spark 20", "KJ5", "13 - 14", "MediaTek Helio G85", "2023-12", "USB-C"),
    ("Tecno Pop 8", "BG6", "13", "Unisoc T606", "2023-09", "USB-C"),
    ("Tecno Camon 20", "CK6n", "13", "MediaTek Helio G85", "2023-05", "USB-C"),
    ("Infinix Hot 30", "X6831", "12 - 13", "MediaTek Helio G88", "2023-03", "USB-C"),
    ("Infinix Hot 40", "X6837", "13 - 14", "MediaTek Helio G99", "2023-10", "USB-C"),
    ("Infinix Smart 8", "X6525", "13", "Unisoc T606", "2023-09", "USB-C"),
    ("Infinix Note 30", "X6833B", "13", "MediaTek Helio G99", "2023-05", "USB-C"),
    ("itel A60s", "A101", "12", "Unisoc SC9863A", "2023-06", "Micro-USB"),
    ("itel A70", "A665L", "13", "Unisoc T606", "2023-10", "USB-C"),
